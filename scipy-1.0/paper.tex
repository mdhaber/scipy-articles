...
\author[3,*]{Tyler Reddy}
\author[4]{Andrew R. J. Nelson}
\author[5]{Anne M. Archibald}
\author[6]{Ant\^{o}nio H. Ribeiro}
\author[7]{CJ Carey}
\author[8]{Charles R Harris}
\author[8]{Denis Laxalde}
\author[8]{E. A. Quintero}
\author[9]{Eric Larson}
\author[10]{Eric W. Moore}
\author[11]{Evgeni Burovski}
\author[12]{Fabian Pedregosa}
\author[13]{Ian Henriksen}
\author[8]{\.{I}lhan Polat}
\author[14]{Jake VanderPlas}
\author[8]{Josef Perktold}
\author[8]{Joshua Wilson}
\author[15,16]{K. Jarrod Millman}
\author[17,*]{Matt Haberland}
\author[18]{Matthew Brett}
\author[19]{St\'efan J. van der Walt}
\author[20,21,22,23,2]{Travis E. Oliphant}
\author[8]{Warren Weckesser}
\author{{SciPy Contributors Consortium}}

\affil[1]{University of Jyv\"askyl\"a, FI-40014 University of Jyv\"askyl\"a, Finland}
\affil[2]{Quansight LLC, Austin, TX, USA}
\affil[3]{Los Alamos National Laboratory, Los Alamos, NM 87544}
\affil[4]{Australian Nuclear Science and Technology Organisation, Locked Bag 2001, Kirrawee DC, NSW 2232, Australia}
\affil[5]{Anton Pannekoek Institute, P.O. Box 94249, 1090 GE Amsterdam, Nederland}
\affil[6]{Graduate Program in Electrical Engineering, Universidade Federal de Minas Gerais, 6627 Av. Antonio Carlos 31270-901 Belo Horizonte, Brazil}
\affil[7]{Google, LLC}
\affil[8]{Independent Researcher}
\affil[9]{Institute for Learning and Brain Sciences, University of Washington, Seattle, WA 98195, USA}
\affil[10]{Bruker Biospin Corp., 15 Fortune Drive, Billerica, MA 01821}
\affil[11]{Higher School of Economics, Myasnitskaya 20, Moscow 101000 Russia}
\affil[12]{Google Research}
\affil[13]{Oden Institute for Computational Engineering and Sciences, The University of Texas at Austin, Austin, Texas 78712-1229, USA}
\affil[14]{University of Washington, Seattle, WA 98195, USA}
\affil[15]{Berkeley Institute for Data Science, University of California, Berkeley, CA 94720 USA}
\affil[16]{Division of Biostatistics, University of California, Berkeley, CA 94720, USA}
\affil[17]{BioResource and Agricultural Engineering, California Polytechnic State University, San Luis Obispo, CA 93407, USA}
\affil[18]{School of Psychology, University of Birmingham, Edgbaston, Birmigham B15 2TT, UK}
\affil[19]{Berkeley Institute for Data Science, University of California Berkeley, Berkeley, CA 94720 USA}
\affil[20]{Ultrasound Imaging, Mayo Clinic, Rochester, MN 55902, USA}
\affil[21]{Electrical Engineering, Brigham Young University, Provo, UT 84604, USA}
\affil[22]{Enthought Inc, Austin, TX 78701, USA}
\affil[23]{Anaconda Inc, Austin, TX 78701, USA}
...
\paragraph{
\newline
Aditya Vijaykumar$^{24,25}$, 
Alessandro Pietro Bardelli$^{8}$, 
Alex Rothberg$^{8}$, 
Andreas Hilboll$^{26}$, 
Andreas Kloeckner$^{27}$, 
Antony Lee$^{28}$, 
Ariel Rokem$^{29}$, 
C. Nathan Woods$^{3}$, 
Chad Fulton$^{30}$, 
Charles Masson$^{31}$, 
Christian Brueffer$^{32}$, 
Christian H\"aggstr\"om$^{33}$, 
Clark Fitzgerald$^{34}$, 
David A. Nicholson$^{35}$, 
David R Hagen$^{36}$, 
Dmitrii V. Pasechnik$^{37}$, 
Emanuele Olivetti$^{38}$, 
Eric Martin$^{8}$, 
Eric Wieser$^{39}$, 
Fabrice Silva$^{40}$, 
Felix Lenders$^{41,42,43}$, 
Florian Wilhelm$^{44}$, 
G. Young$^{8}$, 
Gavin A. Price$^{45}$, 
Gert-Ludwig Ingold$^{46}$, 
Gregory E. Allen$^{47}$, 
Gregory R. Lee$^{48,49}$, 
Herv\'e Audren$^{50}$, 
Irvin Probst$^{51}$, 
J\"org P. Dietrich$^{52,53}$, 
Jacob Silterra$^{54}$, 
James T Webber$^{55}$, 
Janko Slavi\v{c}$^{56}$, 
Joel Nothman$^{57}$, 
Johannes Buchner$^{58,59}$, 
Johannes Kulick$^{60}$, 
Johannes L. Sch\"{o}nberger$^{8}$, 
Jonathan Bright$^{61}$, 
Jos\'e Vin\'icius de Miranda Cardoso$^{62}$, 
Joscha Reimer$^{63}$, 
Joseph Harrington$^{64}$, 
Juan Luis Cano Rodr'iguez$^{65}$, 
Juan Nunez-Iglesias$^{66}$, 
Justin Kuczynski$^{67}$, 
Kevin Tritz$^{68}$, 
Martin Thoma$^{69}$, 
Matthias K\"ummerer$^{70}$, 
Maximilian Bolingbroke$^{71}$, 
Michael Tartre$^{72}$, 
Mikhail Pak$^{73}$, 
Nathaniel J. Smith$^{8}$, 
Nikolai Nowaczyk$^{8}$, 
Nikolay Shebanov$^{74}$, 
Oleksandr Pavlyk$^{75}$, 
Pearu Peterson$^{76,77}$, 
Per A. Brodtkorb$^{78}$, 
Perry Lee$^{8}$, 
Robert Cimrman$^{79}$, 
Robert T. McGibbon$^{80}$, 
Roman Feldbauer$^{81}$, 
Sam Lewis$^{82}$, 
Sam Tygier$^{83}$, 
Scott Sievert$^{84}$, 
...
Tom Krauss$^{95}$, 
Utkarsh Upadhyay$^{96}$, 
Yaroslav O. Halchenko$^{97}$, 
Yoshiki V\'azquez-Baeza$^{98}$, 
Yu Feng$^{99}$}
\hfill \break
\hfill \break
$^{24}$International Centre for Theoretical Sciences, Tata Institute of Fundamental Research, Bengaluru 560089, India, 
$^{25}$Department of Physics, Birla Institute of Technology and Science, Pilani 330331, India, 
$^{26}$Institute of Environmental Physics, University of Bremen, Bremen, Germany, 
$^{27}$Department of Computer Science, University of Illinois at Urbana-Champaign, 201 N. Goodwin Ave, Urbana, IL 616801, USA, 
$^{28}$Laboratoire Photonique, Num\'erique et Nanosciences UMR 5298, Universit\'e de Bordeaux, Institut d'Optique Graduate School, CNRS, 33400 Talence, France, 
$^{29}$The University of Washington eScience Institute, The University of Washington, Seattle, WA 98105, USA, 
$^{30}$Federal Reserve Board of Governors,  20th and Constitution Ave. NW, Washington, DC 20551, U.S.A., 
$^{31}$Datadog Inc., 620 8th Avenue New York, NY 10018, USA, 
$^{32}$Department of Clinical Sciences Lund, Lund University, Lund, Sweden, 
$^{33}$HQ, Orexplore, Torshamnsgatan 30B, Stockholm, Sweden, 
$^{34}$Statistics Department, University of California - Davis, Davis, CA 95616, USA, 
$^{35}$Emory University, Atlanta, GA 30322, USA, 
$^{36}$Applied BioMath, 561 Virginia Rd Ste 220, Concord, MA 01742, USA, 
$^{37}$Department of Computer Science, University of Oxford, Wolfson Building, Parks Road, OX1 3QD Oxford, UK, 
$^{38}$NeuroInformatics Laboratory, Bruno Kessler Foundation, Trento 38123, Italy, 
$^{39}$Department of Engineering, University of Cambridge, Trumpington St, Cambridge CB2 1PZ, UK, 
$^{40}$Aix Marseille Universit\'e., CNRS, Centrale Marseille, LMA, Marseille, France, 
$^{41}$Interdisciplinary Center for Scientific Computing (IWR), Heidelberg University, Im Neuenheimer Feld 205 69120 Heidelberg, Germany, 
$^{42}$ABB Corporate Research, ABB AG, Wallstadter Str. 59 68526 Ladenburg, Germany, 
$^{43}$Institut f\"ur Mathematische Optimierung, Technische Universit\"at Carolo-Wilhelmina zu Braunschweig, Universit\"atsplatz 2 38106 Braunschweig, Germany, 
$^{44}$Independent Researcher, Cologne, Germany, 
$^{45}$Lawrence Berkeley National Laboratory, Berkeley, CA 94720, USA, 
$^{46}$Institut f{\"u}r Physik, Universit{\"a}t Augsburg, Universit{\"a}tsstra{\ss}e 1, 86135 Augsburg, Germany, 
$^{47}$Applied Research Laboratories, The University of Texas at Austin, P.O. Box 8029 Austin, TX 78713, USA, 
$^{48}$Department of Radiology, School of Medicine, University of Cincinnati, Cincinnati, OH 45221, USA, 
$^{49}$Department of Radiology, Cincinnati Children's Hospital Medical Center, Cincinnati, OH 45229, USA, 
$^{50}$Ascent Robotics Inc., 1-6-10 Hiroo Shibuya Tokyo, Japan, 
$^{51}$ENSTA Bretagne, 2 rue François Verny, Brest, France, 
$^{52}$Faculty of Physics, Ludwig-Maximilians-Universit\"at, Scheinerstr. 1, 81679 M\"unchen, Germany, 
$^{53}$Excellence Cluster Universe, Boltzmannstr. 2, 85748 Garching b. M\"unchen, Germany, 
$^{54}$Independent Researcher, USA, 
$^{55}$Data Sciences, Chan Zuckerberg Biohub, San Francisco, CA 94158, USA, 
$^{56}$Faculty of Mechanical Engineering, University of Ljubljana, A\v{s}ker\v{c}eva 6 1000 Ljubljana, Slovenia-EU, 
$^{57}$Sydney Informatics Hub, The University of Sydney, NSW 2006, Australia, 
$^{58}$Instituto de Astrof\'{i}sica, Pontificia Universidad Cat\'{o}lica de Chile, Casilla 306, Santiago 22, Chile, 
$^{59}$Max Planck Institute for Extraterrestrial Physics, Giessenbachstrasse, 85741 Garching, Germany, 
$^{60}$University of Stuttgart, Machine Learning and Robotics Lab, Universitätsstr. 38, 70569 Stuttgart, Germany, 
$^{61}$Independent Researcher, NY, USA, 
$^{62}$Department of Electrical Engineering, Universidade Federal de Campina Grande, 58429900 PB, Brazil, 
$^{63}$Department of Computer Science, Kiel University, 24098 Kiel, Germany, 
$^{64}$Planetary Sciences Group and Florida Space Institute and Department of Physics, University of Central Florida, 4111 Libra Drive Orlando Florida 32816-2385, USA, 
$^{65}$Independent Researcher, Spain, 
$^{66}$Monash Micro Imaging, Monash University, Clayton VIC 3800, Australia, 
$^{67}$Department of Molecular, Cellular, and Developmental Biology, University of Colorado, Boulder, Boulder, CO 80303, USA, 
$^{68}$Department of Physics and Astronomy, Johns Hopkins University, 3400 N. Charles Street, Baltimore, MD 21218, USA, 
$^{69}$Independent Researcher, Munich, Germany, 
$^{70}$University of T\"ubingen, T\"ubingen, Germany, 
$^{71}$Independent Researcher, United Kingdom, 
$^{72}$Two Sigma Investments, 100 Avenue of the Americas 16th Floor, New York, NY 10013, USA, 
$^{73}$Department of Mechanical Engineering, Technical University of Munich, Boltzmannstr. 15, 85748 Garching, Germany, 
$^{74}$Independent Researcher, Berlin, Germany, 
$^{75}$Intel Corp., Austin, TX 78746, USA, 
$^{76}$Independent Researcher, Saue, Estonia, 
$^{77}$Department of Mechanics and Applied Mathematics, Institute of Cybernetics at Tallinn Technical University, Akadeemia Rd 21 Tallinn, Estonia, 
$^{78}$Independent Researcher, Horten, Norway, 
$^{79}$New Technologies - Research Centre, University of West Bohemia, Univerzitní 8, 306 14, Plzeň, Czech Republic, 
$^{80}$D. E. Shaw Research, New York, NY 10036, USA, 
$^{81}$Division of Computational Systems Biology, University of Vienna, Althanstra{\ss}e 14, 1090 Vienna, Austria, 
$^{82}$Independent Researcher, Melbourne, Australia, 
$^{83}$School of Physics and Astronomy, University of Manchester, Oxford Road, M13 9PL, UK, 
$^{84}$Electrical and Computer Engineering, University of Wisconsin--Madison, 1415 Engineering Drive Madison, WI, USA, 
$^{85}$Dipartimento di Informatica, Universit\`a degli Studi di Milano, via Celoria 18, 20133 Milano MI, Italy, 
$^{86}$Department of Computer Engineering, Vishwakarma Institute of Information Technology, Pune, India, 
$^{87}$Inter-University Centre for Astronomy and Astrophysics, Ganeshkhind, Pune, 411007, India, 
$^{88}$Kavli Institute for the Physics and Mathematics of the Universe, Kashiwanoha 5-1-5, Kashiwa-shi, 2778583, Japan, 
$^{89}$Waymo LLC, Mountain View, CA 94043, USA, 
$^{90}$Faculty of Engineering, Niigata University, 8050 Ikarashi-Ninocho, Nishi-ku, Niigata, 9502181, Japan, 
$^{91}$Virginia Polytechnic Institute and State University, Blacksburg, VA 24061, USA, 
$^{92}$Aperio Software, Headingley Enterprise and Arts Centre, Bennett Road, Leeds, LS6 3HN, United Kingdom, 
$^{93}$Broad Institute, Cambridge, MA 02142, USA, 
$^{94}$Department of Psychology, Humboldt University of Berlin, Rudower Chaussee 18, 12489 Berlin, Germany, 
$^{95}$Epiq Solutions, Schaumburg, IL 60173, USA, 
$^{96}$Max Planck Institute for Software Systems, Saarbr\"ucken, Germany, 
$^{97}$Department of Psychology and Brain Sciences, Dartmouth College, Hanover, NH 03755, USA, 
$^{98}$Jacobs School of Engineering, University of California San Diego, 9500 Gilman Drive, La Jolla, CA 92161, USA, 
$^{99}$Berkeley Center for Cosmological Physics, University of California, Berkeley, CA 94720, USA.

...
\author[7]{Ant\^{o}nio H. Ribeiro}
\author[8]{Charles R Harris}
\author[9]{CJ Carey}
\author[8]{Denis Laxalde}
\author[10]{Eric Larson}
\author[11]{Eric W. Moore}
\author[8]{E. A. Quintero}
\author[12]{Evgeni Burovski}
\author[13]{Fabian Pedregosa}
\author[14]{Ian Henriksen}
\author[15]{\.{I}lhan Polat}
\author[16]{Jaime Fernández del Río}
\author[17]{Jake {VanderPlas}}
\author[8]{Josef Perktold}
\author[8]{Joshua Wilson}
\author[3,18]{K. Jarrod Millman}
\author[19,*]{Matt Haberland}
\author[20]{Matthew Brett}
\author[21]{Nikolay Mayorov}
\author[3]{St\'efan J. van der Walt}
\author[22, 23, 24, 25, 2]{Travis E. Oliphant}
\author[8]{Warren Weckesser}
\author{The SciPy Contributors}

% \author[16]{Scott Sievert}
% \author[17]{Yu Feng}

\affil[1]{University of Jyv\"askyl\"a, FI-40014 University of Jyv\"askyl\"a, Finland}
\affil[2]{Quansight LLC, P.O. Box 91891, Austin, TX, USA}
\affil[3]{Berkeley Institute for Data Science, University of California, Berkeley, CA 94720, USA}
\affil[4]{Los Alamos National Laboratory, Theoretical Division 6, Los Alamos, NM 87545, USA}
...
\affil[7]{Graduate Program in Electrical Engineering, Universidade Federal de Minas Gerais, 6627 Av. Antonio Carlos 31270-901 Belo Horizonte, Brazil}
\affil[8]{Independent Researcher}
\affil[9]{Affiliation, department, city, postcode, country}
\affil[10]{Institute for Learning and Brain Sciences, University of Washington, Seattle, WA 98195, USA}
\affil[11]{Bruker Biospin Corp., 15 Fortune Drive, Billerica, MA 01821, USA}
\affil[12]{Higher School of Economics, Myasnitskaya 20, Moscow 101000 Russia}
\affil[13]{Affiliation, department, city, postcode, country}
\affil[14]{University of Texas at Austin, Oden Institute for Computational Engineering and Sciences, Austin, TX 78712, USA}
\affil[15]{Affiliation, department, city, postcode, country}
\affil[16]{Affiliation, department, city, postcode, country}
\affil[17]{University of Washington, Seattle, WA 98195, USA}
\affil[18]{Division of Biostatistics, University of California, Berkeley, CA 94720, USA}
\affil[19]{BioResource and Agricultural Engineering, California Polytechnic State University, San Luis Obispo, CA 93407, USA}
\affil[20]{School of Psychology, University of Birmingham, Edgbaston, Birmigham B15 2TT, UK}
\affil[21]{Affiliation, department, city, postcode, country}
% \affil[16]{Electrical and Computer Engineering, University of Wisconsin--Madison, 1415 Engineering Drive Madison, WI 53706, USA}
% \affil[17]{Berkeley Center for Cosmological Physics, University of California, Berkeley, CA 94720 USA}
\affil[22]{Ultrasound Imaging, Mayo Clinic, Rochester, MN 55902, USA}
\affil[23]{Electrical Engineering, Brigham Young University, Provo, UT 84604, USA}
\affil[24]{Enthought Inc, Austin, TX 78701, USA}
\affil[25]{Anaconda Inc, Austin, TX 78701, USA}
